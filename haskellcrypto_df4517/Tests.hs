...
phiTestCases
  = [ 0 ==> 0
    ...
    , 6 ==> 2
    , 18 ==> 6
    , 17 ==> 16 -- example: p ==> p - 1, where p = prime
    , 31 ==> 30 -- example: p ==> p - 1, where p = prime
    , 35 ==> 24 -- example: pq ==> (p - 1)(q - 1)
    , 77 ==> 60
    , 221 ==> 192 -- further example: pq ==> (p - 1)(q - 1)
    ]
